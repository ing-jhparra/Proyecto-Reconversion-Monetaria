...
diccionariocsv = ruta + 'diccionarioFundacion.csv'
updatescsv = ruta + 'updatesFundacion.csv'
...
select_distinct_diccionario = 'SELECT DISTINCT nombretabla FROM tempdb..BDNDiccionario ORDER BY 1;'
select_campos_tablas = 'SELECT nombrecampo FROM tempdb..BDNDiccionario WHERE nombretabla = \'{}\' AND espk != 1 ORDER BY 1;'
